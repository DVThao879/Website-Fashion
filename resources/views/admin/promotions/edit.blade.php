                ...
                <div class="collapse show" id="collapseProductInfo">
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="code" placeholder="Nhập mã..." name="code" value="{{ $promotion->code }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="discount_percentage">Phần trăm giảm giá:</label>
                            <input type="number" name="discount_percentage" id="discount_percentage" placeholder="Nhập % giảm..." class="form-control" step="0.01" min="1" max="100" value="{{ $promotion->discount_percentage }}" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-check-input ml-2" value="1" type="checkbox" @checked($promotion->is_active) name="is_active" id="is_active">
                        </div>
                    </div>
                </div>
            </div>
